...
async def lifespan(app: FastAPI):
    # Beim Start klar sagen, welcher Stand läuft. So sieht man im Log sofort,
    # ob ein Neubau wirklich angekommen ist.
    from . import release as R
    print(f"Netboard {R.VERSION} „{R.CODENAME}“ startet – Daten: {C.DATA_DIR}",
          flush=True)
